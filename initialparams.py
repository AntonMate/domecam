...
def processBestThresh(img, acc=None):
    ...
    # скорее всего это нужно будет переделать. сделать один отцу + мед фильтрация
...
def processCn2(cc, y, x, gammas, conjugated_distance=None, heights_of_layers=None):
